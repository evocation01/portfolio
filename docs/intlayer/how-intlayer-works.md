...
-   using [vscode extension](/doc/vs-code-extension)
...
> To see all the features of Intlayer, you can read the [dictionary documentation](/doc/concept/content).
...
Intlayer also provides a visual editor to allow you to edit your content in a visual way. This [visual editor](/doc/concept/editor) is available in the external `intlayer-editor` package.
...
By activating the option `importMode = "dynamic"` in the [configuration](/doc/concept/configuration), Intlayer will use the dynamic import to load the dictionaries. This option is disabled by default to avoid async processing when rendering the application.
...
To see how to configure the build of your application, you can read the [configuration documentation](/doc/concept/configuration).
